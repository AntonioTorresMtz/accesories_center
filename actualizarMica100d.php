<?php
        ...
        if(isset($_SESSION['exito_actual_Mica100d'])){
            echo "<script type='text/javascript'>Swal.fire(
                        'Actualizacion exitosa!',
                        'Se ha actualizado la cantidad de Micas exitosamente!',
                        'success'
                      )</script>";
                unset($_SESSION['exito_actual_Mica100d']);
        }
...
?>
    <div class="container">
        <form action="registros/actualizacion_Mica100d.php" method="POST" class="row g-3 mt-3" id="formulario">
            <h3 class="display-5 text-dark text-center font-weight-bold">Actualizar Micas de Privacidad</h3>
            <div class="col-6">
...
<script src="js/select100d_agregar.js"></script>
