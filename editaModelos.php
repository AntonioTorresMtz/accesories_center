...
<div class="container">
    <div class="row justify-content-center mt-3">
        <form action="registros/editaTipoProtector.php" id="formulario" method="POST"
            ...
            <div class="col-12">
                ...
                <input class="form-control" type="text" min="0" name="nombre" id="nombre" placeholder="Nuevo nombre"
                    required>
            </div>
...
<script>
    $(document).ready(function () {
        $('#tipo').change(function () {
            var tipoId = $(this).val();
            $.ajax({
                url: 'select/getTipoProtector.php',
                type: 'post',
                data: { tipoId: tipoId },
                dataType: 'json',
                success: function (response) {
                    $('#nombre').val(response.nombre);
                    // Aquí puedes autocompletar los otros campos (clave, ruta_imagen, precio) si los tienes
                }
            });
        });
    });
