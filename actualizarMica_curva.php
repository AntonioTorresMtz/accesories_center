...
?>
    <div class="container">
        <form action="registros/actualizacion_MicaCurva.php" method="POST" class="row g-3 mt-3" id="formulario">
            <h3 class="display-5 text-dark text-center font-weight-bold">Actualizar Micas Curva</h3>
            <div class="col-6">
