...
if (isset($_SESSION['exito_ventaMica100d'])) {
    echo "<script type='text/javascript'>Swal.fire(
                        'Exito en venta!',
                        'Se ha registrado la mica con exito!',
                        'success'
                      )</script>";
    unset($_SESSION['exito_ventaMica100d']);
}

if (isset($_SESSION['error_ventaMica100d'])) {
    echo "<script type='text/javascript'>Swal.fire(
                        'Error en venta!',
                        'No se pudo encontrar el modelo seleccionado!',
                        'error'
                      )</script>";
    unset($_SESSION['error_ventaMica100d']);
}

?>
<div class="container">
    <div class="row justify-content-center mt-3">
        <form action="registros/ventaMica100d.php" method="POST" class="col-md-3 shadow p-3 align-self-start"
            id="formulario">
            <div class="row text-center">
                <h4>Venta mica de privacidad</h4>
            </div>
            <div class="col-12">
