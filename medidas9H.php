    ...
    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" class="row g-3 mt-3 align-items-center">
        <div class="col-3">
            ...
            <input type="number" class="form-control" placeholder="Ancho" aria-label="Username"
                aria-describedby="basic-addon1" name="ancho" id="ancho" step="any" required
                value="<?php echo $ancho?>">
        </div>

        <div class="col-3">
            <label class="form-label" for="largo">Largo:</label>
            <input type="number" class="form-control" placeholder="Largo" aria-label="Username"
                aria-describedby="basic-addon1" name="largo" id="largo" step="any" required
                value="<?php echo $largo?>">
        </div>
