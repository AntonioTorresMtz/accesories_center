...
?>
    <div class="container">
        <form action="registros/ventaMicaCurva.php" method="POST" class="row g-3 mt-3" id="formulario">
            <h3 class="display-5 text-dark text-center font-weight-bold">Venta micas curvas</h3>
            <div class="col-6">
