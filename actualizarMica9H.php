...
if (isset($_SESSION['exito_actual_Mica9h'])) {
...
<div class="container">
    <div class="row justify-content-center mt-3">
        <form action="registros/actualizacion_Mica9H.php" method="POST" class="col-md-3 shadow p-3 align-self-start"
            id="formulario">
            <div class="row text-center">
                <h4>Actualizar mica normal</h4>
            </div>
            <div class="col-12">
...
<script src="js/select9h_agregar.js"></script>
