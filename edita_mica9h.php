...
$query = "SELECT m.marca as name_marca, a.marca, a.ancho, a.largo, a.camara, a.posicion, p.nombre as name_posicion, p.muro, a.boton
FROM micas9h a
...
<div class="container">
    <form action="editar/e_general9h.php" method="POST" class="row g-3 mt-3">
        ...
        <div class="col-6">
            ...
            <input type="number" name="ancho" step="any" id="ancho" class="form-control" value="<?php echo $ancho ?>" required>
        </div>

        <div class="col-6">
            <label for="largo" class="form-label">Largo:</label>
            <input type="number" name="largo" step="any" id="largo" class="form-control" value="<?php echo $largo ?>" required> 
        </div>
