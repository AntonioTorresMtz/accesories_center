...
if (isset($_SESSION['exito_actual_MicaCamara'])) {
...
<div class="container">
    <div class="row justify-content-center mt-3">
        <form action="registros/actualizacion_MicaCamara.php" method="POST" class="col-md-3 shadow p-3 align-self-start"
            id="formulario">
            <div class="row text-center">
                <h4>Actualizar micas camara</h4>
            </div>
            <div class="col-12">
...
<script src="js/selectCamara_agregar.js"></script>
