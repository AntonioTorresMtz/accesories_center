...
<body>
  <?php
  session_start();
  // Establece la codificación después de establecer la conexión
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="vistaVentasPersonalizadas.php">Lista de
                  Personalizadas</a></li>
              <hr class="dropdown-divider">
          </li>
          ...
          <li><a class="dropdown-item" href="ventaMenu_micaCamaraIndi.php">Mica camara (Individual) </a></li>
          <li>
            <hr class="dropdown-divider">
          </li>
          <li><a class="dropdown-item" href="ventaMenu_micaCamara.php">Mica camara (Completa) </a></li>
          <li>
            <hr class="dropdown-divider">
          </li>
