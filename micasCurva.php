...
<div class="container">
    <div class="row justify-content-center mt-3">
        <form action="registros/nuevaMicaCurva.php" method="POST" class="col-12 col-sm-8 col-md-6 col-lg-3 mx-auto shadow p-3 align-self-start"
            id="formulario">
            <div class="row text-center">
                <h4>Nueva mica curva</h4>
            </div>
            <div class="row">
                <div class="col-12">
